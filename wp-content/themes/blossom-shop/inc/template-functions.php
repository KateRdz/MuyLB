...
function blossom_shop_sticky_bar(){ 
    $sticky_text    = get_theme_mod( 'sticky_text', __( 'End of Season SALE now on thru 1/21.','blossom-shop' ) );
    $sticky_url     = get_theme_mod( 'sticky_url', '#' );
    $sticky_button  = get_theme_mod( 'sticky_button', __( 'SHOP NOW', 'blossom-shop' ) );
    
    if( $sticky_text || ( $sticky_button && $sticky_url ) ) : ?>
