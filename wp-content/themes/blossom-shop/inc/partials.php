...
function blossom_shop_get_sticky_text(){
    return esc_html( get_theme_mod( 'sticky_text', __( 'End of Season SALE now on thru 1/21.','blossom-shop' ) ) );
}
endif;
...
function blossom_shop_get_sticky_button(){
    return esc_html( get_theme_mod( 'sticky_button', __( 'SHOP NOW', 'blossom-shop' ) ) );
}
endif;
